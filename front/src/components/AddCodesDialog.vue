...
import { store, Checker } from '../store';
  ...
  <TransitionRoot as="template" :show="isOpen">
    ...
    >
      ...
      >
        ...
        >
          <div
            class="inline-block w-full px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-gray-900 rounded-lg shadow-xl  sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6"
          >
            <div>
...
Code 2
..."
                      class="px-2 py-1 text-gray-300 placeholder-gray-400 uppercase bg-gray-800 rounded-md  h-52 max-h-36 focus:ring-orange-500 focus:ring focus:ring-opacity-50 focus:outline-none"
                    ></textarea>
                  </div>
                </div>
              </div>
